...
<div class="card">
    ...
    <div class="col-md-12">
       <form method="post">
        <!-- ini kode ubah status pembayaran -->
        <?php
        $id = $_GET['id'];
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8">
                    <select name="status_bayar" class="form-control">
                        ...
                        <option value="berhasil" <?php if($data['status_bayar'] == 'berhasil') echo 'selected'; ?>>Berhasil</option>
                        <option value="gagal" <?php if($data['status_bayar'] == 'gagal') echo 'selected'; ?>>Gagal</option>
