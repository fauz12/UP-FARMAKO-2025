...
<div class="row">
    <div class="col-md-12">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <!-- ini kode untuk menampilkan data kursi yang ada diadmin -->
            <?php
            $i = 1;
                ...
                while($data = mysqli_fetch_array($query)){
                    ...
                    <tr>
                        ...
                        <td>
                        <a onclick="return confirm('Apakah anda yakin menghapus data ini?')" href="?page=kursiadmin_hapus&&id=<?php echo $data['id_penumpang']; ?>" class="btn btn-danger">Hapus</a>
                        </td>
                    </tr>
            <?php
                }
